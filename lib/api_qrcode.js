 ...
 */
exports.createTmpQRCode = function (sceneId, expire) {
 ...
 * 创建临时二维码的未封装版本
 */
exports._createTmpQRCode = function (sceneId, expire) {
  var url = this.prefix + 'qrcode/create?access_token=' + token.accessToken;
  var data = {
 ...
 */
exports.createLimitQRCode = function (sceneId) {
 ...
 * 创建永久二维码的未封装版本
 */
exports._createLimitQRCode = function (sceneId) {
  var url = this.prefix + 'qrcode/create?access_token=' + token.accessToken;
  var data = {
