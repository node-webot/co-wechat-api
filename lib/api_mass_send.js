 ...
 */
exports.massSend = async function (opts, receivers) {
  var token = await this.ensureAccessToken();
  var url;
...
exports.massSendNews = async function (mediaId, receivers) {
  var opts = {
    'mpnews': {
      'media_id': mediaId
    },
  ...
  return await this.massSend(opts, receivers);
};
 ...
 * @param {String|Array} receivers 接收人。一个组，或者openid列表 */
exports.massSendText = async function (content, receivers) {
  var opts = {
    'text': {
      'content': content
    },
 ...
 * @param {String|Array} receivers 接收人。一个组，或者openid列表 */
exports.massSendVoice = async function (mediaId, receivers) {
  var opts = {
    'voice': {
      'media_id': mediaId
    },
 ...
 * @param {String|Array} receivers 接收人。一个组，或者openid列表 */
exports.massSendImage = async function (mediaId, receivers) {
  var opts = {
    'image': {
      'media_id': mediaId
    },
 ...
 * @param {String|Array} receivers 接收人。一个组，或者openid列表
 */
exports.massSendVideo = async function (mediaId, receivers) {
  var opts = {
    'mpvideo': {
      'media_id': mediaId
    },
 ...
 * @param {String|Array} receivers 接收人。一个组，或者openid列表 */
exports.massSendMPVideo = async function (data, receivers) {
  // 自动帮转视频的media_id
  var result = await this.uploadMPVideo(data);
  return await this.massSendVideo(result.media_id, receivers);
};
