 ...
 * 上传图文消息的未封装版本
 */
exports._uploadNews = function (news) {
 ...
 * 上传视频消息的未封装版本
 */
exports._uploadMPVideo = function (opts) {
 ...
 * 群发消息的未封装版本
 */
exports._massSend = function (opts, receivers) {
  var url;
...
exports._deleteMass = function (messageId) {
  var opts = {
    msg_id: messageId
  };
...
exports._previewNews = function (openid, mediaId) {
  var opts = {
    "touser": openid,
    "mpnews": {
      "media_id": mediaId
...
exports._previewText = function (openid, content) {
  var opts = {
    "touser": openid,
    "text": {
      "content": content
...
exports._previewVoice = function (openid, mediaId) {
  var opts = {
    "touser": openid,
    "voice": {
      "media_id": mediaId
...
exports._previewImage = function (openid, mediaId) {
  var opts = {
    "touser": openid,
    "image": {
      "media_id": mediaId
...
exports._previewVideo = function (openid, mediaId) {
  var opts = {
    "touser": openid,
    "mpvideo": {
      "media_id": mediaId
...
exports._getMassMessageStatus = function (messageId) {
  var opts = {
   "msg_id": messageId
  };
