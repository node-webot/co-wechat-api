...
exports.addPoi = function* (poi) {
  ...
  var url = this.prefix + 'poi/addpoi?access_token=' + token.accessToken;
...
exports.getPoi = function* (poiId) {
  var token = yield this.ensureAccessToken();
  var url = this.prefix + 'poi/getpoi?access_token=' + token.accessToken;
  var data = {
    poi_id: poiId
  };
  return yield this.request(url, postJSON(data));
 ...
 */
exports.getPois = function* (begin, limit) {
  var token = yield this.ensureAccessToken();
  var url = this.prefix + 'poi/getpoilist?access_token=' + token.accessToken;
  var data = {
    begin: begin,
    limit: limit
  };
 ...
 * @param {Number} poiId 门店ID
 */
exports.delPoi = function* (poiId) {
  var token = yield this.ensureAccessToken();
  var url = this.prefix + 'poi/delpoi?access_token=' + token.accessToken;
  var data = {
    poi_id: poiId
  };
  return yield this.request(url, postJSON(data));
 ...
 * @param {Object} poi 门店对象
 */
exports.updatePoi = function* (poi) {
  var token = yield this.ensureAccessToken();
  var data = {
    business: {
      base_info: poi
  ...
  var url = this.prefix + 'poi/updatepoi?access_token=' + token.accessToken;
  return yield this.request(url, postJSON(data));
};
