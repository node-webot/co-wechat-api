 ...
 * 获取用户基本信息的未封装版本
 */
exports._getUser = function (options) {
 ...
 * 批量获取用户基本信息的未封装版本
 */
exports._batchGetUsers = function (openids) {
 ...
 * 获取关注者列表的未封装版本
 */
exports._getFollowers = function (nextOpenid) {
 ...
 * 设置用户备注名的未封装版本
 */
exports._updateRemark = function (openid, remark) {
