 ...
 */
exports.registerShakeAccount = async function (options) {
  var token = await this.ensureAccessToken();
  var url = 'https://api.weixin.qq.com/shakearound/account/register?access_token=' + token.accessToken;
  return await this.request(url, postJSON(options));
};
 ...
 */
exports.checkShakeAccountStatus = async function () {
  var token = await this.ensureAccessToken();
  var url = 'https://api.weixin.qq.com/shakearound/account/auditstatus?access_token=' + token.accessToken;
 ...
 * @param {Object} options 请求参数
 */
exports.applyBeacons = async function (options) {
  var token = await this.ensureAccessToken();
  var url = 'https://api.weixin.qq.com/shakearound/device/applyid?access_token=' + token.accessToken;
  return await this.request(url, postJSON(options));
};
 ...
 * @param {Object} options 请求参数
 */
exports.updateBeacon = async function (options) {
  var token = await this.ensureAccessToken();
  var url = 'https://api.weixin.qq.com/shakearound/device/update?access_token=' + token.accessToken;
  return await this.request(url, postJSON(options));
};
 ...
 * @param {Object} options 请求参数
 */
exports.bindBeaconLocation = async function (options) {
  var token = await this.ensureAccessToken();
  var url = 'https://api.weixin.qq.com/shakearound/device/bindlocation?access_token=' + token.accessToken;
  return await this.request(url, postJSON(options));
};
 ...
 * @param {Object} options 请求参数
 */
exports.getBeacons = async function (options) {
  var token = await this.ensureAccessToken();
  var url = 'https://api.weixin.qq.com/shakearound/device/search?access_token=' + token.accessToken;
  return await this.request(url, postJSON(options));
};
...
exports.createPage = async function (page) {
  var token = await this.ensureAccessToken();
  var url = 'https://api.weixin.qq.com/shakearound/page/add?access_token=' + token.accessToken;
  return await this.request(url, postJSON(page));
};
...
exports.updatePage = async function (page) {
  var token = await this.ensureAccessToken();
  var url = 'https://api.weixin.qq.com/shakearound/page/update?access_token=' + token.accessToken;
  return await this.request(url, postJSON(page));
};
 ...
 */
exports.deletePages = async function (page_ids) {
  var token = await this.ensureAccessToken();
  var data = {page_ids: page_ids};
  var url = 'https://api.weixin.qq.com/shakearound/page/delete?access_token=' + token.accessToken;
 ...
 * @param {Object} options 请求参数
 */
exports.getPages = async function (options) {
  var token = await this.ensureAccessToken();
  var url = 'https://api.weixin.qq.com/shakearound/page/search?access_token=' + token.accessToken;
  return await this.request(url, postJSON(options));
};
...
exports.uploadPageIcon = async function (filepath) {
  ...
  var url = 'https://api.weixin.qq.com/shakearound/material/add?access_token=' + token.accessToken;
  var opts = {
    dataType: 'json',
    method: 'POST',
    timeout: 60000, // 60秒超时
 ...
 * @param {Object} options 请求参数
 */
exports.bindBeaconWithPages = async function (options) {
  var token = await this.ensureAccessToken();
  var url = 'https://api.weixin.qq.com/shakearound/device/bindpage?access_token=' + token.accessToken;
  return await this.request(url, postJSON(options));
};
 ...
 * @param {Object} options 请求参数
 */
exports.searchBeaconPageRelation = async function (options) {
  var token = await this.ensureAccessToken();
  var url = 'https://api.weixin.qq.com/shakearound/relation/search?access_token=' + token.accessToken;
  return await this.request(url, postJSON(options));
};
...
exports.getShakeInfo = async function (ticket) {
  ...
  var url = 'https://api.weixin.qq.com/shakearound/user/getshakeinfo?access_token=' + token.accessToken;
  return await this.request(url, postJSON(data));
};
 ...
 * @param {Object} options 请求参数
 */
exports.getDeviceStatistics = async function (options) {
  var token = await this.ensureAccessToken();
  var url = 'https://api.weixin.qq.com/shakearound/statistics/device?access_token=' + token.accessToken;
  return await this.request(url, postJSON(options));
};
...
exports.getPageStatistics = async function (options) {
  var token = await this.ensureAccessToken();
  var url = 'https://api.weixin.qq.com/shakearound/statistics/page?access_token=' + token.accessToken;
  return await this.request(url, postJSON(options));
};
