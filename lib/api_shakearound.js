 ...
 */
exports.checkShakeAccountStatus = function* () {
  var token = yield this.ensureAccessToken();
 ...
 * @param {Object} options 请求参数
 */
exports.applyBeacons = function* (options) {
  var token = yield this.ensureAccessToken();
 ...
 * @param {Object} options 请求参数
 */
exports.updateBeacon = function* (options) {
  var token = yield this.ensureAccessToken();
 ...
 * @param {Object} options 请求参数
 */
exports.bindBeaconLocation = function* (options) {
  var token = yield this.ensureAccessToken();
 ...
 * @param {Object} options 请求参数
 */
exports.getBeacons = function* (options) {
  var token = yield this.ensureAccessToken();
...
exports.createPage = function* (page) {
  ...
  return yield this.request(url, postJSON(page));
};
 ...
 */
exports.deletePages = function* (page_ids) {
  var token = yield this.ensureAccessToken();
 ...
 */
exports.uploadPageIcon = function* (filepath) {
  var token = yield this.ensureAccessToken();
 ...
 * @param {Object} options 请求参数
 */
exports.bindBeaconWithPages = function* (options) {
  var token = yield this.ensureAccessToken();
 ...
 * @param {Object} options 请求参数
 */
exports.searchBeaconPageRelation = function* (options) {
  var token = yield this.ensureAccessToken();
 ...
 * @param {Object} options 请求参数
 */
exports.getDeviceStatistics = function* (options) {
  var token = yield this.ensureAccessToken();
 ...
 * @param {Object} options 请求参数
 */
exports.getPageStatistics = function* (options) {
  var token = yield this.ensureAccessToken();
