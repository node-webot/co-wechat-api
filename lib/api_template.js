...
exports._setIndustry = function (industryIds) {
  var apiUrl = this.prefix + 'template/api_set_industry?access_token=' + token.accessToken;
  this.request(apiUrl, postJSON(industryIds));
};
...
exports._sendTemplate = function (openid, templateId, url, topColor, data) {
  ...
  this.request(apiUrl, postJSON(template));
};
