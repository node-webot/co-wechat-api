...
exports.uploadVideoMaterial = async function (filepath, description) {
  ...
  var url = prefixUrl + 'material/add_material?access_token=' + token.accessToken + '&type=video';
  var opts = {
    dataType: 'json',
    method: 'POST',
    timeout: 60000, // 60秒超时
...
exports.uploadNewsMaterial = async function (news) {
  ...
  return await this.request(url, postJSON(news));
};
...
exports.getMaterial = async function (mediaId) {
  var token = await this.ensureAccessToken();
  var url = this.prefix + 'material/get_material?access_token=' + token.accessToken;
  var opts = {
    method: 'POST',
...
exports.removeMaterial = async function (mediaId) {
  ...
  return await this.request(url, postJSON({'media_id': mediaId}));
};
