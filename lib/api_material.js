 ...
 * 上传永久文件的未封装版本
 */
exports._uploadMaterial = function (filepath, type) {
 ...
 * 上传永久文件（视频）的未封装版本
 */
exports._uploadVideoMaterial = function (filepath, description) {
 ...
 * 新增永久图文素材的未封装版本
 */
exports._uploadNewsMaterial = function (news) {
  var url = this.prefix + 'material/add_news?access_token=' + token.accessToken;
 ...
 * 新增永久图文素材的未封装版本
 */
exports._updateNewsMaterial = function (news) {
  var url = this.prefix + 'material/add_news?access_token=' + token.accessToken;
  return yield * this.request(url, postJSON(news));
};
 ...
 * 下载永久素材的未封装版本
 */
exports._getMaterial = function (mediaId) {
  var prefix = 'https://api.weixin.qq.com/cgi-bin/';
  var url = prefix + 'material/get_material?access_token=' + token.accessToken;
  var opts = {
    type: 'POST',
  ...
  return yield * this.request(url, opts, wrapper(function (err, data, res) {
    // handle some err
    if (err) {
      return callback(err);
    }
 ...
 * 删除永久素材的未封装版本
 */
exports._removeMaterial = function (mediaId) {
  var prefix = 'https://api.weixin.qq.com/cgi-bin/';
  var url = prefix + 'material/del_material?access_token=' + token.accessToken;
  return yield * this.request(url, postJSON({'media_id': mediaId}));
};
 ...
 * 删除永久素材的未封装版本
 */
exports._getMaterialCount = function () {
  var prefix = 'https://api.weixin.qq.com/cgi-bin/';
  var url = prefix + 'material/get_materialcount?access_token=' + token.accessToken;
 ...
 * 获取永久素材列表的未封装版本
 */
exports._getMaterials = function (type, offset, count) {
  var prefix = 'https://api.weixin.qq.com/cgi-bin/';
  var url = prefix + 'material/batchget_material?access_token=' + token.accessToken;
  var data = {
    type: type,
    offset: offset,
    count: count
