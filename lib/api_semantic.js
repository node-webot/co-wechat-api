 ...
 */
exports.semantic = function (uid, opts) {
 ...
 * 发送语义理解请求的未封装版本
 */
exports._semantic = function (uid, opts) {
  // https://api.weixin.qq.com/semantic/semproxy/search?access_token=YOUR_ACCESS_TOKEN
  var url = 'https://api.weixin.qq.com/semantic/semproxy/search?access_token=' + token.accessToken;
