 ...
 */
exports.deliverNotify = function (data) {
 ...
 * 发货通知的未封装版本
 */
exports._deliverNotify = function (data) {
  var url = this.payPrefix + 'delivernotify?access_token=' + token.accessToken;
 ...
 */
exports.orderQuery = function (query) {
 ...
 * 发货通知的未封装版本
 */
exports._orderQuery = function (query) {
  var url = this.payPrefix + 'orderquery?access_token=' + token.accessToken;
  return yield * this.request(url, postJSON(query));
};
