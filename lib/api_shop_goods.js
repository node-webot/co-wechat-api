 ...
 */
exports.createGoods = function (goods) {
 ...
 * 增加商品的未封装版本
 */
exports._createGoods = function (goods) {
  var url = this.merchantPrefix + 'create?access_token=' + token.accessToken;
  return yield * this.request(url, postJSON(goods));
};
 ...
 */
exports.deleteGoods = function (productId) {
 ...
 * 删除商品的未封装版本
 */
exports._deleteGoods = function (productId) {
  var data = {
    "product_id": productId
  };
  var url = this.merchantPrefix + 'del?access_token=' + token.accessToken;
 ...
 */
exports.updateGoods = function (goods) {
 ...
 * 修改商品的未封装版本
 */
exports._updateGoods = function (goods) {
  var url = this.merchantPrefix + 'update?access_token=' + token.accessToken;
  return yield * this.request(url, postJSON(goods));
};
 ...
 */
exports.getGoods = function (productId) {
 ...
 * 根据状态获取商品列表
 */
exports._getGoods = function (productId) {
  var url = this.merchantPrefix + 'get?product_id=' + productId + '&access_token=' + token.accessToken;
 ...
 */
exports.getGoodsByStatus = function (status) {
 ...
 * 获取指定状态的所有商品的未封装版本
 */
exports._getGoodsByStatus = function (status) {
  var data = {status: status};
  var url = this.merchantPrefix + 'getbystatus?access_token=' + token.accessToken;
  return yield * this.request(url, postJSON(data));
};
 ...
 */
exports.updateGoodsStatus = function (productId, status) {
 ...
 * 商品上下架的未封装版本
 */
exports._updateGoodsStatus = function (productId, status) {
  var data = {
    product_id: productId,
    status: status
  };
  var url = this.merchantPrefix + 'modproductstatus?access_token=' + token.accessToken;
  return yield * this.request(url, postJSON(data));
};
 ...
 */
exports.getSubCats = function (catId) {
 ...
 * 获取指定分类的所有子分类的未封装版本
 */
exports._getSubCats = function (catId) {
  var data = {
    cate_id: catId
  };
  var url = this.merchantPrefix + 'category/getsub?access_token=' + token.accessToken;
  return yield * this.request(url, postJSON(data));
};
 ...
 */
exports.getSKUs = function (catId) {
 ...
 * 获取指定子分类的所有SKU的未封装版本
 */
exports._getSKUs = function (catId) {
  var data = {
    cate_id: catId
  };
  var url = this.merchantPrefix + 'category/getsku?access_token=' + token.accessToken;
  return yield * this.request(url, postJSON(data));
};
 ...
 */
exports.getProperties = function (catId) {
 ...
 * 获取指定分类的所有属性的未封装版本
 */
exports._getProperties = function (catId) {
  var data = {
    cate_id: catId
  };
  var url = this.merchantPrefix + 'category/getproperty?access_token=' + token.accessToken;
  return yield * this.request(url, postJSON(data));
};
