...
/**
 * 客服消息，发送图文链接
 * 详细细节 https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/customer-message/customerServiceMessage.send.html
 * Examples:
 * ```
 * var link = {
 *  title: '消息标题', // 必填
 *  description: '图文链接消息', // 必填
 *  url: '图文链接消息被点击后跳转的链接', // 必填
 *  thumb_url: "图文链接消息的图片链接，支持 JPG、PNG 格式，较好的效果为大图 640 X 320，小图 80 X 80" // 必填
 * };
 * api.sendLink('openid', link);
 * ```

 * @param {String} openid 用户的openid
 * @param {Object} link 图文链接信息
 */
