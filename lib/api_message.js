 ...
 * 客服消息，发送文字消息的未封装版本
 */
exports._sendText = function (openid, text) {
  // {
  //  "touser":"OPENID",
  //  "msgtype":"text",
  //  "text": {
 ...
 * 客服消息，发送图片消息的未封装版本
 */
exports._sendImage = function (openid, mediaId) {
  // {
  //  "touser":"OPENID",
  //  "msgtype":"image",
  //  "image": {
 ...
 * 客服消息，发送语音消息的未封装版本
 */
exports._sendVoice = function (openid, mediaId) {
  // {
  //  "touser":"OPENID",
  //  "msgtype":"voice",
  //  "voice": {
 ...
 * 客服消息，发送视频消息的未封装版本
 */
exports._sendVideo = function (openid, mediaId, thumbMediaId) {
  // {
  //  "touser":"OPENID",
  //  "msgtype":"video",
  //  "image": {
 ...
 * 客服消息，发送音乐消息的未封装版本
 */
exports._sendMusic = function (openid, music) {
  // {
  //  "touser":"OPENID",
  //  "msgtype":"music",
  //  "music": {
 ...
 * 客服消息，发送图文消息的未封装版本
 */
exports._sendNews = function (openid, articles) {
  // {
  //  "touser":"OPENID",
  //  "msgtype":"news",
  //  "news":{
