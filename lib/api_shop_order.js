...
exports.getOrderById = async function (orderId) {
  ...
  var url = this.merchantPrefix + 'order/getbyid?access_token=' + accessToken;
...
exports.getOrdersByStatus = async function (status, beginTime, endTime) {
  ...
  var url = this.merchantPrefix + 'order/getbyfilter?access_token=' + accessToken;
  return this.request(url, postJSON(data));
};
...
exports.setExpressForOrder = async function (orderId, deliveryCompany, deliveryTrackNo, isOthers) {
  ...
  var url = this.merchantPrefix + 'order/setdelivery?access_token=' + accessToken;
  return this.request(url, postJSON(data));
};
...
exports.closeOrder = async function (orderId) {
  ...
  var url = this.merchantPrefix + 'order/close?access_token=' + accessToken;
  return this.request(url, postJSON(data));
};
