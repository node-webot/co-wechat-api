...
exports.getOrderById = async function (orderId) {
  ...
  var url = this.merchantPrefix + 'order/getbyid?access_token=' + token.accessToken;
 ...
 */
exports.getOrdersByStatus = async function (status, beginTime, endTime) {
  var token = await this.ensureAccessToken();
  var data = {};
  ...
  var url = this.merchantPrefix + 'order/getbyfilter?access_token=' + token.accessToken;
  return await this.request(url, postJSON(data));
};
 ...
 */
exports.setExpressForOrder = async function (orderId, deliveryCompany, deliveryTrackNo, isOthers) {
  var token = await this.ensureAccessToken();
  var data = {
    'order_id': orderId,
  ...
  if (typeof isOthers === 'undefined') {
    data.is_others = 0;
  } else {
    data.is_others = isOthers ? 1 : 0;
  }
  var url = this.merchantPrefix + 'order/setdelivery?access_token=' + token.accessToken;
  return await this.request(url, postJSON(data));
};
 ...
 * @param {String} orderId 订单Id
 */
exports.setNoDeliveryForOrder = async function (orderId) {
  var token = await this.ensureAccessToken();
  var data = {
    'order_id': orderId,
    'need_delivery': 0
 ...
 * @param {String} orderId 订单Id
 */
exports.closeOrder = async function (orderId) {
  var token = await this.ensureAccessToken();
  var data = {
    'order_id': orderId
  };
  var url = this.merchantPrefix + 'order/close?access_token=' + token.accessToken;
  return await this.request(url, postJSON(data));
};
