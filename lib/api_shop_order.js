 ...
 */
exports.getOrdersByStatus = function* (status, beginTime, endTime) {
  var token = yield* this.ensureAccessToken();
  var data = {};
 ...
 */
exports.setExpressForOrder = function* (orderId, deliveryCompany, deliveryTrackNo, isOthers) {
  var token = yield* this.ensureAccessToken();
  var data = {
    "order_id": orderId,
 ...
 * @param {String} orderId 订单Id
 */
exports.setNoDeliveryForOrder = function* (orderId) {
  var token = yield* this.ensureAccessToken();
  var data = {
    "order_id": orderId,
    "need_delivery": 0
