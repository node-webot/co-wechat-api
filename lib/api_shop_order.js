 ...
 * 根据订单ID获取订单详情的未封装版本
 */
exports._getOrderById = function (orderId) {
  var data = {
    "order_id": orderId
  };
 ...
 */
exports._getOrdersByStatus = function (status, beginTime, endTime) {
  var data = {};
 ...
 */
exports.setExpressForOrder = function (orderId, deliveryCompany, deliveryTrackNo) {
 ...
 * 设置订单发货信息的未封装版本
 */
exports._setExpressForOrder = function (orderId, deliveryCompany, deliveryTrackNo) {
  var data = {
    "order_id": orderId,
