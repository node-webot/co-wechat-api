 ...
 * 增加货架的未封装版本
 */
exports._createShelf = function (shelf) {
 ...
 * 删除货架的未封装版本
 */
exports._deleteShelf = function (shelfId) {
  var data = {
    "shelf_id": shelfId
  };
 ...
 * 修改货架的未封装版本
 */
exports._updateShelf = function (shelf) {
 ...
 * 获取所有货架的未封装版本
 */
exports._getAllShelves = function () {
 ...
 * 根据货架ID获取货架信息的未封装版本
 */
exports._getShelfById = function (shelfId) {
  var data = {
    "shelf_id": shelfId
  };
