 ...
 */
exports.createShelf = async function (shelf) {
  const { accessToken } = await this.ensureAccessToken();
  var url = this.merchantPrefix + 'shelf/add?access_token=' + accessToken;
  return this.request(url, postJSON(shelf));
};
 ...
 */
exports.deleteShelf = async function (shelfId) {
  const { accessToken } = await this.ensureAccessToken();
  var data = {
    'shelf_id': shelfId
  };
  var url = this.merchantPrefix + 'shelf/del?access_token=' + accessToken;
 ...
 * @param {Object} shelf 货架信息
 */
exports.updateShelf = async function (shelf) {
  const { accessToken } = await this.ensureAccessToken();
  var url = this.merchantPrefix + 'shelf/mod?access_token=' + accessToken;
  return this.request(url, postJSON(shelf));
};
 ...
 * ```
 */
exports.getAllShelves = async function () {
  const { accessToken } = await this.ensureAccessToken();
  var url = this.merchantPrefix + 'shelf/getall?access_token=' + accessToken;
 ...
 * @param {String} shelfId 货架Id
 */
exports.getShelfById = async function (shelfId) {
  const { accessToken } = await this.ensureAccessToken();
  var data = {
    'shelf_id': shelfId
  };
  var url = this.merchantPrefix + 'shelf/getbyid?access_token=' + accessToken;
  return this.request(url, postJSON(data));
};
